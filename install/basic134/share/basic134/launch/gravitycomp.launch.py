"""Launch the Gravity Compensation demo

This instantiates the HEBI node and runs the gravity compensation demo.
...
This should start
     ...
     4) gravitycomp, making the arm "float"
...
def generate_launch_description():
    ...
    node_gravitycomp = Node(
        name       = 'gravitycomp', 
        package    = 'basic134',
        executable = 'gravitycomp',
        output     = 'screen')
